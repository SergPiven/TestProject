...
namespace RemoteNotes.UI.Shell.Managers
{
    public class ControlManager
    {
        ...
        public void Place(string containerName, string regionName, string elementName)
        {
            ContentControl containerControl =
             this.GetControl(containerName) as ContentControl;
            ContentControl elementControl =
             this.GetControl(elementName) as ContentControl;
