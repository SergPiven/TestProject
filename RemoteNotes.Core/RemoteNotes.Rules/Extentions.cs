...
namespace RemoteNotes.Rules
{
    public static class Extensions
    {
        ...
        {
            bool isValid =
            value.Length >= minLength && value.Length <= maxLength && value.IsString();
            return isValid;
        }
        /// <summary>
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        public static bool IsStringWithAdditionalSymbols(this string value,
        string addition)
        {
        ...
        public static bool IsStringWithAdditionalSymbols(this string value,
        string addition, int minLength, int maxLength)
        {
            string pattern = string.Format(@"^[a-zA-Z{0}]+$", addition);
            bool isValid = Regex.IsMatch(value, pattern) &&
